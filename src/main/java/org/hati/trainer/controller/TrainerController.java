...
public class TrainerController {
	...
	// 인기 트레이너 목록 조회
	@GetMapping("/popular")
	public List<TrainerSummaryVO> getPopularTrainers(@RequestParam Integer loginAccountId) {
        return trainerService.getPopularTrainers(loginAccountId);
	}
	
	// 맞춤 트레이너 목록 조회
	@GetMapping("/matched")
    public List<TrainerSummaryVO> getMatchedTrainers(@RequestParam Integer loginAccountId) {
    ...
    public void toggleBookmark(@RequestParam int accountId, @PathVariable int trainerId) {
